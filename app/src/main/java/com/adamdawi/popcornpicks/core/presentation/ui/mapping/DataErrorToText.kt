...
fun DataError.asUiText(): String {
    return when(this) {
        DataError.Local.DISK_FULL -> "Failed to save because your disk is full."
        DataError.Network.REQUEST_TIMEOUT -> "The request timed out."
        DataError.Network.NO_INTERNET -> "Couldn't reach server, please check your internet connection."
